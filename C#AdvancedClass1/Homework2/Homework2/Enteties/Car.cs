...
namespace Homework2.Enteties
{
    public class Car : Vehicle, ICarWash, IGasPump, IRepairService
    {
        ...
        public Car(string Make, string Model, int HorsePower, bool IsClean, bool IsGasFull, bool IsBroken, bool IsDriven, bool IsChecked) : base(Make, Model, HorsePower, IsClean, IsGasFull, IsBroken, IsDriven, IsChecked)
        {
